...
public class ShufflingCardsDiv2 {
	public String shuffle(int[] permutation) {
		...
		// after second shuffle, should have even position contain the first half in first shuffle
		// this part will contain n / 4 number that in range (n / 2, n]
		int cnt = 0;
		for (int i = 0; i < n; i += 2) {
			if (permutation[i] > n / 2) cnt++;
		}
		return cnt == n / 4 ? "Possible" : "Impossible";
	}
